...
### Описание проекта    
Итоговый проект первого блока курса DSPR Skillfsctory 2024 года.
...
### Какой кейс решаем?    
Осуществляем разведывательный анализ и очистку данных
...
**Что практикуем**     
Практикуем работу с библиотеками pandas, numpu и plotly.


### Краткая информация о данных
В качестве набора данных используется выгрузка резюмэ с сайта hh.ru за 2018-2019 годы.
[Датасет](https://drive.google.com/file/d/1oELr3XUzugvz6l9i_dqXlEHvBcczgkgI/view?usp=sharing)    

:arrow_up:[к оглавлению](https://github.com/eartzhi/HH_project/blob/main/README.md#%D0%BE%D0%B3%D0%BB%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5)

### Этапы работы над проектом  
Работа разбита на 3 этапа:
1. Подготовка данных
2. Изучение общих зависимостей
3. Очитска данных
